...
%>
<%List<User> list3;
if(departmentId == 0 && srchText == null) list3 = UserDAO2.findAll();
else if(departmentId == 0 && srchText != null) list3 = UserDAO2.findByName(srchText);
else if(departmentId !=0 && srchText == null) list3 = UserDAO2.findByDepartmentId(departmentId);
else list3=UserDAO2.findByNameAndDepartmentId(srchText, departmentId);
%>
<!DOCTYPE html>
<html>
<head>
